...
public class testMainForPurchase {
	/** 
	 ...
	 */
		...
		public static void main(String[] args) {
			...
			testPurchase p1 = new testPurchase();
			...
			testPurchase p2 = new testPurchase();
			...
			testPurchase p3 = new testPurchase("A super shiny new blue mouse mat", 
									   19, 1.60);
			System.out.println(p3);
			
			testPurchase p4 = new testPurchase("Keyboard", 15, 14.39);
			System.out.printf("\n%s total price: €%.2f",
